  ...
  return (
    <aside className={cn(
      ...
      <div className="flex items-center space-x-3 px-2 mb-6">
        ...
        <span className="text-lg font-semibold tracking-tight text-white font-display">Aura Pro</span>
        ...
        <div className="p-8">
          <div className="max-w-3xl mx-auto relative">
            ...
            <div className="text-center mt-3 text-[10px] text-gray-600 tracking-tight">
              Aura Pro may display inaccurate info, including about people, so double-check its responses.
            </div>
          </div>
        </div>
      </main>
